...
class Calculation:
    ...
    def convert_args_to_tuple_of_float(tuple_list):
        ...
        # then i make it a tuple again because i actually won't need to change the calculations values
        # I can also use it as a list and then i would be able to edit the calculations
        list_values_float = []
...
class Multiplication(Calculation):
    """multiplication calculations object"""
...
class Subtraction(Calculation):
    """subtraction calculations object"""
